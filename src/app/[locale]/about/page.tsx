    ...
    <div className="min-h-screen bg-black">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="space-y-8">
          ...
          <div className="card p-8">
            ...
            <ul className="space-y-3 text-zinc-400">
              <li className="flex items-start gap-3">
                ...
                Browse conferences by category like AI, Web, Security, DevOps, and more
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-5 h-5 text-green-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                Find conferences with open Call for Papers and their deadlines
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-5 h-5 text-green-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                Search by name, location, or technology tags
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-5 h-5 text-green-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                Add conferences to your calendar with one click
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-5 h-5 text-green-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                Use Speaker Mode to show only conferences accepting talk submissions
              </li>
            </ul>
          </div>
          ...
          {/* Data Updates */}
          <div className="card p-8">
            <h2 className="text-xl font-bold text-white mb-4">How We Keep Data Fresh</h2>
            <p className="text-zinc-400 leading-relaxed">
              Conference information is updated automatically every day. We pull data from
              multiple public sources to provide comprehensive coverage of tech events.
              If you notice missing or incorrect information, feel free to open an issue
          ...
          <div className="card p-8">
            ...
            <div className="flex flex-wrap gap-4">
              <a
                ...
                className="flex items-center gap-2 px-4 py-2 rounded-lg bg-zinc-800 hover:bg-zinc-700 text-white transition-colors border border-zinc-700"
              >
              ...
              <a
                href="https://www.buymeacoffee.com/mohitmishra"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 px-4 py-2 rounded-lg bg-yellow-500 hover:bg-yellow-400 text-black font-medium transition-colors"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
